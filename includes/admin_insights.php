...
const NON_ACTIVITY_TABLES = [
    ...
    'push_subscriptions'    => 'اعتبارنامه‌ی دستگاه برای اعلانِ گوشی',
    // ⛔ یک **اجازه**ی مدیر است، نه کارِ کاربر — همان استدلالِ
    //    `payments`. با شمردنش، سهامداری که هنوز هیچ تراکنشی ثبت
    //    نکرده «فعال» دیده می‌شد و قیفِ شروع دقیقاً همان افتی را
    //    پنهان می‌کرد که برای دیدنش ساخته شده.
    'store_shareholders'    => 'اجازه‌ی مدیر است، نه رکوردِ دفترِ کاربر',
    // ⛔ آینه‌ی تسویه‌های سمتِ فروشگاه است — `StoreShare::applySettlements()`
    //    می‌سازدش، نه کاربر. با شمردنش، سهامداری که فقط پولش را گرفته
    //    «فعال» دیده می‌شد در حالی که هیچ ردیفی در دفترِ خودش ننوشته.
    'store_settlements'     => 'آینه‌ی سمتِ فروشگاه است، نه کارِ کاربر',
    // ⛔ تیکتِ پشتیبانی رکوردِ **دفتر** نیست؛ گفت‌وگو با ماست. با
    //    شمردنش، کاربری که فقط یک سؤال پرسیده «فعال» دیده می‌شد و قیفِ
    //    شروع دقیقاً همان افتی را پنهان می‌کرد که برای دیدنش ساخته شده.
    'support_tickets'       => 'گفت‌وگو با پشتیبانی است، نه رکوردِ دفتر',
    'support_messages'      => 'گفت‌وگو با پشتیبانی است، نه رکوردِ دفتر',
    'support_attachments'   => 'پیوستِ همان گفت‌وگوست، نه رکوردِ دفتر',
];
