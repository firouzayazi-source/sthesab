...
echo
info "⛔ بعد از نارنجی شدن، همین آدرس از بیرون ۴۰۳ می‌دهد و آن **درست است**:"
info "درخواست از کلادفلر می‌آید، جایگزینی انجام می‌شود، و آی‌پیِ دیده‌شده"
info "دیگر 127.0.0.1 نیست. پس آن را نشانه‌ی خرابی نگیرید."
