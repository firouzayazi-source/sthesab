...
<div class="card" id="smsCaptureCard" hidden>
    ...
    <?php /* ⛔ پیش‌فرض **روشن** (خواستِ مالکِ نصب؛ `smsAutoEnabled()` در app.js)
             و انتخابش روی **همین دستگاه** می‌ماند نه در
             ...
             اتفاق نمی‌افتد؛ و خاموش کردنش یک `'0'`ِ صریح می‌نویسد،
             پس «دست نزده» با «نخواسته» یکی نمی‌شود. */ ?>
