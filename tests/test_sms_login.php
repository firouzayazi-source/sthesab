...
// ⛔ **یک** دکمه در هر کارت، نه دو تا. دو دکمه‌ی کنارِ هم شبیه دو جای
//    تست خوانده می‌شدند و کاربر اولی را می‌زد و منتظرِ پیامک می‌ماند.
// ⚠ فقط خودِ دکمه شمرده می‌شود، نه انتخابگرِ همان کلاس در اسکریپت.
T::same(3, substr_count($accessSrc, 'btn-block js-sms-submit'),
    '⛔ هر کارتِ اتصال دقیقاً یک دکمه دارد');
