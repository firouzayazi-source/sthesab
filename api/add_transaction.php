...
//
// ⚠ `id` یک کلیدِ **افزوده** است، نه تغییر: راهِ «لغو» برای ثبتِ خودکار
//   از پیامک بدون آن ممکن نبود (باید شناسه را حدس می‌زد یا فهرست را
//   دوباره می‌خواند). هیچ مصرف‌کننده‌ی قبلی‌ای نمی‌شکند.
jsonResponse([
    'success' => true,
